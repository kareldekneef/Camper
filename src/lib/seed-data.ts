...
export const defaultMasterItems: MasterItem[] = [
  ...
  item('mi-out-zijwand', 'Zijwand', 'cat-camper', {}, { weight: 3000 }),
  item('mi-out-zonnescherm', 'Zonnescherm', 'cat-camper', { weather: ['hot', 'mixed'] }, { weight: 2000 }),
  item('mi-out-boodschappentas', 'Opvouwbare boodschappentas', 'cat-camper', {}, { weight: 100 }),
  item('mi-out-diepvriestas', 'Diepvriestas', 'cat-camper', {}, { weight: 500 }),
  item('mi-camper-grondzeil', 'Grondzeil (extra groot)', 'cat-camper', {}, { weight: 3000 }),
  item('mi-camper-opstapje', 'Opstapje', 'cat-camper', {}, { weight: 2000 }),
  item('mi-camper-tarps', 'Grote tarps', 'cat-camper', {}, { weight: 2500 }),
  item('mi-camper-extrakabel', 'Extra elektrisch kabel', 'cat-camper', {}, { weight: 1000 }),
  item('mi-camper-oprijblokken', 'Extra oprijblokken', 'cat-camper', {}, { weight: 1500 }),
  item('mi-camper-gasslang', 'Lange gasslang', 'cat-camper', {}, { weight: 500 }),
  item('mi-camper-fietsdrager', 'Fietsdrager', 'cat-camper', { activities: ['cycling'] }, { weight: 5000 }),
  item('mi-camper-zonnepaneel', 'Klein zonnepaneel', 'cat-camper', {}, { weight: 1500 }),
  item('mi-camper-elektrischedeken', 'Elektrische deken', 'cat-camper', { weather: ['cold'] }, { weight: 1500 }),
  item('mi-camper-elektrischegrill', 'Elektrische grill', 'cat-camper', {}, { weight: 2500 }),
  item('mi-camper-paninirooster', 'Panini toaster', 'cat-camper', {}, { weight: 1800 }),
  item('mi-camper-broodrooster', 'Broodrooster voor gaspit', 'cat-camper', {}, { weight: 800 }),
  item('mi-camper-fluitketel', 'Fluitketel / waterkoker', 'cat-camper', {}, { weight: 600 }),
  item('mi-camper-extraglazen', 'Extra glazen', 'cat-camper', {}, { weight: 600 }),
  ...
  item('mi-cloth-petten', 'Petten', 'cat-clothing', {}, { quantity: 1, perPerson: true, weight: 100 }),
  item('mi-cloth-mutsen', 'Mutsen', 'cat-clothing', { weather: ['cold'] }, { quantity: 1, perPerson: true, weight: 100 }),
  ...
  item('mi-cloth-badjas', 'Badjas', 'cat-clothing', {}, { quantity: 1, perPerson: true, weight: 800 }),
  item('mi-cloth-heuptasje', 'Heuptasje', 'cat-clothing', {}, { quantity: 1, perPerson: true, weight: 150 }),
  item('mi-cloth-buff', 'Buff / nekwarmer', 'cat-clothing', { weather: ['cold', 'mixed'] }, { quantity: 1, perPerson: true, weight: 80 }),
  item('mi-cloth-fietsbroek', 'Fietsbroek', 'cat-clothing', { activities: ['cycling'] }, { quantity: 1, perPerson: true, weight: 200 }),
  item('mi-cloth-fietshelm', 'Fietshelm', 'cat-clothing', { activities: ['cycling'] }, { quantity: 1, perPerson: true, weight: 300 }),
  ...
  item('mi-out-camera', 'Camera + statief + tas', 'cat-electronics', { activities: ['photography'] }, { weight: 3000 }),
  item('mi-elec-handheld', 'Nintendo DS / handheld console', 'cat-electronics', {}, { weight: 300 }),
  ...
  item('mi-elec-waterdichterugzak', 'Waterdichte rugzak', 'cat-outdoor', {}, { weight: 800 }),
  item('mi-elec-dagrugzak', 'Kleine dagrugzak', 'cat-outdoor', {}, { weight: 500 }),
  item('mi-elec-boeken', 'Boeken', 'cat-outdoor', {}, { weight: 300 }),
  item('mi-cloth-wandelstokken', 'Wandelstokken', 'cat-outdoor', { activities: ['hiking'] }, { weight: 500 }),
  item('mi-out-picknickkleed', 'Picknickkleed', 'cat-outdoor', { weather: ['hot', 'mixed'] }, { weight: 800 }),
  item('mi-out-extravislijn', 'Extra vislijn', 'cat-outdoor', { activities: ['fishing'] }, { weight: 100 }),
  item('mi-out-rondestoelen', 'Ronde stoelen', 'cat-outdoor', {}, { weight: 3000 }),
  ...
  item('mi-camper-vaatwasmiddel', 'Vaatwasmiddel / spullen', 'cat-cleaning', {}, { weight: 500 }),
  item('mi-camper-handdoeken', 'Handdoeken voor vaat', 'cat-cleaning', {}, { quantity: 2, weight: 150 }),
  item('mi-clean-vuilnisbak', 'Vuilnisbak voor binnen', 'cat-cleaning', {}, { weight: 500 }),
  item('mi-clean-afdruiprekje', 'Afdruiprekje', 'cat-cleaning', {}, { weight: 400 }),
  item('mi-clean-douchepenningen', 'Douchepenningen', 'cat-cleaning', {}, { weight: 50 }),
