...
export const defaultMasterItems: MasterItem[] = [
  ...
  item('Waterschoenen', 'cat-clothing', { activities: ['swimming'] }, { quantity: 1, perPerson: true }),
  ...
  item('Zwembroek', 'cat-clothing', { weather: ['hot', 'mixed'], activities: ['swimming'] }, { quantity: 1, perPerson: true }),
